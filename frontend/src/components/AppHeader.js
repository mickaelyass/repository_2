...
import Notification from '../views/comp/Notification'
import {
  CContainer,
  CDropdown,
  CDropdownItem,
    ...
    <CHeader position="sticky" className="mb-4  py-4 p-0" ref={headerRef}>
      <CContainer className="border-bottom px-4" fluid>
        ...
        <CHeaderNav>
          ...
          <CButton  onClick={logout} className='bg-light text-dark p-2'>
              <CIcon icon={cilAccountLogout} className='mx-2 text-danger '/>
              Deconnexion
          </CButton> 
