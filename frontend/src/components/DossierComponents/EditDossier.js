      ...
      const initialDossier = {
        ...
        infoPro: {
          ...
          branche_du_personnel:
            fetchedDossier.InfoPro?.branche_du_personnel || "",
          ...
          responsabilite_partiuliere:
            fetchedDossier.InfoPro?.responsabilite_partiuliere || "",
          grade_paye: fetchedDossier.InfoPro?.grade_paye || "",
          indice_paye: fetchedDossier.InfoPro?.indice_paye || 0,
          dat_first_prise_de_service:
            fetchedDossier.InfoPro?.dat_first_prise_de_service || "",
          dat_de_depart_retraite:
            fetchedDossier.InfoPro?.dat_de_depart_retraite || "",
          dat_de_prise_service_dans_departement:
            fetchedDossier.InfoPro?.dat_de_prise_service_dans_departement || null,
          ref_acte_de_prise_service_poste_actuel:
            fetchedDossier.InfoPro?.ref_acte_de_prise_service_poste_actuel ||
            "",
          poste_actuel_service:
            fetchedDossier.InfoPro?.poste_actuel_service || "",
        ...
        infoComplementaire: {
          observation_particuliere:
            fetchedDossier.InfoComplementaire?.observation_particuliere || "",
          distinction: fetchedDossier.InfoComplementaire?.distinction || "",
          ref_distinction:
            fetchedDossier.InfoComplementaire?.ref_distinction || "",
          detail_distinction:
            fetchedDossier.InfoComplementaire?.detail_distinction || "",
          situat_sante: fetchedDossier.InfoComplementaire?.situat_sante || "",
          saction_punitive:
            fetchedDossier.InfoComplementaire?.saction_punitive || "",
          nature_sanction:
            fetchedDossier.InfoComplementaire?.nature_sanction || "",
        },
      };
