...
const DossierFormUser = ({ dossier, onSubmit }) => {
  const initialValues = { 
    matricule: '',
    infoIdent: {
      cnss: '',
  ...
  const validationSchema = Yup.object({
    ...
    infoPro: Yup.object({
      ...
      etat_depart: Yup.string().required('État départ is required'),
    ...
    >
       {({ values, setFieldValue }) => {
        ...
        const handleDateChange = (event) => {
          ...
          if (name === 'infoPro.dat_first_prise_de_service' && value) {
            const startDate = new Date(value);
            const retirementDate = new Date(startDate.setFullYear(startDate.getFullYear() + 30));
      ...
      <Form>
        ...
        <div className="form-group">
          ...
          <Field name="infoIdent.dat_nat" type="date" className="form-control" />
        ...
        <div className="form-group">
          ...
          <Field name="infoPro.categorie" type="text" className="form-control" />
...
export default DossierFormUser;
