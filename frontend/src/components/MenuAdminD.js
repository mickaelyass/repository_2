...
<div className="top-bar mx-3 bg-white py-1 shadow-sm mt-1"></div>
      ...
      <span className='h4 bg-clair my-4 ms-auto'>
          <span className=' ' onClick={handleGoBack} ><i className='bi-clair text-light bi bi-arrow-left-circle'></i></span>
          <span className=' ms-2' onClick={handleGo} ><i className='bg-clair  text-light bi bi-arrow-right-circle'></i></span>
      </span>
      </div>
