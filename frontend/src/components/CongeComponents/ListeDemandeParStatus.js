...
const ListeDemandesParStatus = ({ status  }) => {
  ...
  const handleManageDemande = (id_cong) => {
    navigate(`/directrice-demande/${id_cong}`);
  };
  ...
  return (
    <div>
      <h2 className="card-title text-light bg-clair  py-2 ps-2 mb-3">Liste des demandes de congés {status} par le chef Service</h2>
