          ...
          <div className='col'>
            <div className="container py-2">
              <div className="container">
                <h2>Formulaire de mise a disposition</h2>
                <Formik
                  initialValues={{
                    etat_depart: "",
                    poste_actuel: "",
                  ...
                  {({ isSubmitting }) => (
                    <Form>
                      <div className="form-group">
                        ...
                        <Field name="etat_depart"  value='Mise a disposition' className="form-control"></Field>
                      ...
                      <div className="form-group">
                        <label>Motif de la mise a disposition</label>
                      ...
                      <div className="form-group">
                        <label>Type de mise a disposition</label>
